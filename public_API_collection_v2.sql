...
insert  into `languages`(`id`,`name`,`iso_code`,`native_name`,`write_direction`) values (6,'Amharic','am','','ltr'),(10,'Assamese','as','অসমীয়া','ltr'),(13,'Azeri','az','Azərbaycan dili','ltr'),(16,'Bulgarian','bg','Български','ltr'),(20,'Bengali','bn','বাংলা','ltr'),(23,'Bosnian','bs','Bosanski','ltr'),(25,'Chechen','ce','','ltr'),(29,'Czech','cs','Čeština','ltr'),(33,'German','de','Deutsch','ltr'),(34,'Divehi, Dhivehi, Maldivian','dv','ދިވެހި','ltr'),(38,'English','en','English','ltr'),(40,'Spanish','es','Español','ltr'),(43,'Persian','fa','فارسی','rtl'),(45,'Finnish','fi','Suomi','ltr'),(49,'French','fr','Français','ltr'),(56,'Gujarati','gu','ગુજરાતી','ltr'),(58,'Hausa','ha','','ltr'),(59,'Hebrew','he','עברית','rtl'),(60,'Hindi','hi','हिन्दी','ltr'),(67,'Indonesian','id','Bahasa Indonesia','ltr'),(74,'Italian','it','Italiano','ltr'),(76,'Japanese','ja','日本語','ltr'),(78,'Georgian','ka','ქართული','ltr'),(82,'Kazakh','kk','Қазақ','ltr'),(84,'Central Khmer','km','','ltr'),(86,'Korean','ko','한국어','ltr'),(89,'Kurdish','ku','Kurdî','ltr'),(95,'Ganda','lg','','ltr'),(106,'Malayalam','ml','മലയാളം','ltr'),(108,'Marathi','mr','मराठी','ltr'),(109,'Maranao','mrn','','ltr'),(110,'Malay','ms','Bahasa Melayu','ltr'),(116,'Nepali','ne','नेपाली','ltr'),(118,'Dutch','nl','Nederlands','ltr'),(120,'Norwegian','no','Norsk','ltr'),(126,'Oromo','om','','ltr'),(131,'Polish','pl','Polski','ltr'),(132,'Pashto','ps','پښتو','rtl'),(133,'Portuguese','pt','Português','ltr'),(137,'Romanian','ro','Română','ltr'),(138,'Russian','ru','Русский','ltr'),(142,'Sindhi','sd','','ltr'),(143,'Northern Sami','se','','ltr'),(145,'Sinhala, Sinhalese','si','සිංහල','ltr'),(150,'Somali','so','','ltr'),(151,'Albanian','sq','Shqip','ltr'),(152,'Serbian','sr','Српски','ltr'),(156,'Swedish','sv','Svenska','ltr'),(157,'Swahili','sw','Kiswahili','ltr'),(158,'Tamil','ta','தமிழ்','ltr'),(159,'Telugu','te','తెలుగు','ltr'),(160,'Tajik','tg','','ltr'),(161,'Thai','th','ภาษาไทย','ltr'),(164,'Tagalog','tl','','ltr'),(167,'Turkish','tr','Türkçe','ltr'),(169,'Tatar','tt','','ltr'),(172,'Uighur, Uyghur','ug','','rtl'),(173,'Ukrainian','uk','Українська','ltr'),(174,'Urdu','ur','اردو','rtl'),(175,'Uzbek','uz','','ltr'),(177,'Vietnamese','vi','Tiếng Việt','ltr'),(183,'Yoruba','yo','','ltr'),(185,'Chinese','zh','中文','ltr'),(187,'Albanian','al','Albanian',''),(188,'Amazigh','zgh','Tamaziɣt','ltr');
...
insert  into `srch_result_occur_details`(`id`,`searched_id`,`verse`,`ayat_id`,`ayat`,`translation`,`translator`,`language`) values (1853,13,'15:51',3,'وَنَبِّئْهُمْ عَن ضَيْفِ إِبْرَٰهِيمَ','Wanabbi/hum AAan dayfi <em>ibraheem</em>','Transliteration','english'),(2552,13,'21:69',4,'قُلْنَا يَـٰنَارُ كُونِى بَرْدًا وَسَلَـٰمًا عَلَىٰٓ إِبْرَٰهِيمَ','Qulna ya naru kooneebardan wasalaman AAala <em>ibraheem</em>','Transliteration','english'),(2655,22,'22:60',1,'۞ ذَٰلِكَ وَمَنْ عَاقَبَ بِمِثْلِ مَا عُوقِبَ بِهِۦ ثُمَّ بُغِىَ عَلَيْهِ لَيَنصُرَنَّهُ ٱللَّهُ ۗ إِنَّ ٱللَّهَ لَعَفُوٌّ غَفُورٌ','Thalika waman AAaqaba bimithlima AAooqiba bihi thumma bughiya AAalayhi layansurannahuAllahu inna Allaha laAAafuwwun <em>ghafoor</em>','Transliteration','english'),(2977,8,'26:45',2,'فَأَلْقَىٰ مُوسَىٰ عَصَاهُ فَإِذَا هِىَ تَلْقَفُ مَا يَأْفِكُونَ','So Moses cast his staff and imagine, it swallowed up what they were <em>shamming</em> about!','Dr. T. B. Irving','english'),(3001,13,'26:69',1,'وَٱتْلُ عَلَيْهِمْ نَبَأَ إِبْرَٰهِيمَ','Watlu AAalayhim nabaa <em>ibraheem</em>','Transliteration','english'),(3357,8,'29:17',5,'إِنَّمَا تَعْبُدُونَ مِن دُونِ ٱللَّهِ أَوْثَـٰنًا وَتَخْلُقُونَ إِفْكًا ۚ إِنَّ ٱلَّذِينَ تَعْبُدُونَ مِن دُونِ ٱللَّهِ لَا يَمْلِكُونَ لَكُمْ رِزْقًا فَٱبْتَغُوا۟ عِندَ ٱللَّهِ ٱلرِّزْقَ وَٱعْبُدُوهُ وَٱشْكُرُوا۟ لَهُۥٓ ۖ إِلَيْهِ تُرْجَعُونَ','You serve only idols instead of Allah (God), and create a <em>sham</em>. The ones you serve instead of Allah (God) do not control any sustenance for you, so seek sustenance from Allah (God) Himself and serve Him; act grateful towards Him; to Him will you ','Dr. T. B. Irving','english'),(3621,22,'34:15',3,'لَقَدْ كَانَ لِسَبَإٍ فِى مَسْكَنِهِمْ ءَايَةٌ ۖ جَنَّتَانِ عَن يَمِينٍ وَشِمَالٍ ۖ كُلُوا۟ مِن رِّزْقِ رَبِّكُمْ وَٱشْكُرُوا۟ لَهُۥ ۚ بَلْدَةٌ طَيِّبَةٌ وَرَبٌّ غَفُورٌ','Laqad kana lisaba-in fee maskanihim ayatunjannatani AAan yameenin washimalin kuloo min rizqirabbikum washkuroo lahu baldatun tayyibatunwarabbun <em>ghafoor</em>','Transliteration','english'),(3688,22,'35:28',2,'وَمِنَ ٱلنَّاسِ وَٱلدَّوَآبِّ وَٱلْأَنْعَـٰمِ مُخْتَلِفٌ أَلْوَٰنُهُۥ كَذَٰلِكَ ۗ إِنَّمَا يَخْشَى ٱللَّهَ مِنْ عِبَادِهِ ٱلْعُلَمَـٰٓؤُا۟ ۗ إِنَّ ٱللَّهَ عَزِيزٌ غَفُورٌ','Wamina annasi waddawabbiwal-anAAami mukhtalifun alwanuhu kathalikainnama yakhsha Allaha min AAibadihialAAulamao inna Allaha AAazeezun <em>ghafoor</em>','Transliteration','english'),(3874,8,'37:86',3,'أَئِفْكًا ءَالِهَةً دُونَ ٱللَّهِ تُرِيدُونَ','Is it some <em>sham</em>; do you want (other) gods instead of Allah (God) [Himself].','Dr. T. B. Irving','english'),(3892,13,'37:104',2,'وَنَـٰدَيْنَـٰهُ أَن يَـٰٓإِبْرَٰهِيمُ','Wanadaynahu an ya <em>ibraheem</em>','Transliteration','english'),(3897,13,'37:109',5,'سَلَـٰمٌ عَلَىٰٓ إِبْرَٰهِيمَ','Salamun AAala <em>ibraheem</em>','Transliteration','english'),(4480,8,'45:7',1,'وَيْلٌ لِّكُلِّ أَفَّاكٍ أَثِيمٍ','How awful will it be for every <em>shamming</em> sinner','Dr. T. B. Irving','english'),(4538,8,'46:28',4,'فَلَوْلَا نَصَرَهُمُ ٱلَّذِينَ ٱتَّخَذُوا۟ مِن دُونِ ٱللَّهِ قُرْبَانًا ءَالِهَةًۢ ۖ بَلْ ضَلُّوا۟ عَنْهُمْ ۚ وَذَٰلِكَ إِفْكُهُمْ وَمَا كَانُوا۟ يَفْتَرُونَ','If only those whom they have adopted as gods in order to gain access [to Heaven] instead of [trusting] Allah (God), had supported them! Instead they left them in the lurch. That was because of their <em>shamming</em> and of what they had invented.','Dr. T. B. Irving','english'),(4928,16,'55:27',1,'وَيَبْقَىٰ وَجْهُ رَبِّكَ ذُو ٱلْجَلَـٰلِ وَٱلْإِكْرَامِ','Wayabqa wajhu rabbika thooaljalali wal-<em>ikram</em>','Transliteration','english'),(4979,16,'55:78',2,'تَبَـٰرَكَ ٱسْمُ رَبِّكَ ذِى ٱلْجَلَـٰلِ وَٱلْإِكْرَامِ','Tabaraka ismu rabbika theealjalali wal-<em>ikram</em>','Transliteration','english'),(5106,22,'58:2',4,'ٱلَّذِينَ يُظَـٰهِرُونَ مِنكُم مِّن نِّسَآئِهِم مَّا هُنَّ أُمَّهَـٰتِهِمْ ۖ إِنْ أُمَّهَـٰتُهُمْ إِلَّا ٱلَّـٰٓـِٔى وَلَدْنَهُمْ ۚ وَإِنَّهُمْ لَيَقُولُونَ مُنكَرًا مِّنَ ٱلْقَوْلِ وَزُورًا ۚ وَإِنَّ ٱللَّهَ لَعَفُوٌّ غَفُورٌ','Allatheena yuthahiroonaminkum min nisa-ihim ma hunna ommahatihim inommahatuhum illa alla-ee waladnahumwa-innahum layaqooloona munkaran mina alqawli wazooran wa-innaAllaha laAAafuwwun <em>ghafoor</em>','Transliteration','english');
...
insert  into `srch_searched_keys`(`id`,`searched_key`,`occur_times`,`searched_at`) values (1,'ibraheem',6,'2022-01-05 10:26:56'),(2,'ibrahim',9,'2022-01-05 10:26:56'),(3,'sham',7,'2022-01-05 10:26:56'),(4,'sham',7,'2022-01-05 10:26:56'),(5,'sham',7,'2022-01-05 10:26:56'),(6,'sham',7,'2022-01-05 10:26:56'),(7,'sham',7,'2022-01-05 10:28:01'),(8,'sham',7,'2022-01-05 10:28:46'),(9,'ibraheem',8,'2022-01-05 10:29:20'),(10,'ibraheem',8,'2022-01-05 10:33:03'),(11,'ibraheem',8,'2022-01-05 10:34:18'),(12,'ibraheem',8,'2022-01-05 10:34:48'),(13,'ibraheem',8,'2022-01-05 10:37:35'),(14,'shad',0,'2022-01-05 10:38:34'),(15,'ikram',2,'2022-01-05 10:39:11'),(16,'ikram',2,'2022-01-05 10:43:36'),(17,'ghafoor',4,'2022-01-05 10:43:55'),(18,'ghafoor',4,'2022-01-05 10:49:41'),(19,'ghafoor',4,'2022-01-05 10:51:13'),(20,'ghafoor',4,'2022-01-05 13:52:54'),(21,'ghafoor',4,'2022-01-06 12:11:46'),(22,'ghafoor',4,'2022-01-06 19:17:36');
...
CREATE TABLE `srch_word_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_searched_key_for_s_words` (`searched_id`),
  CONSTRAINT `fk_searched_key_for_s_words` FOREIGN KEY (`searched_id`) REFERENCES `srch_searched_keys` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4;

/*Data for the table `srch_word_details` */

insert  into `srch_word_details`(`id`,`ayaat_id`,`searched_id`,`word`) values (1,4,15,'ٱلَّذِينَ'),(2,4,15,'يُظَٰهِرُونَ'),(3,4,15,'مِنكُم'),(4,4,15,'مِّن'),(5,4,15,'نِّسَآئِهِم'),(6,4,15,'مَّا'),(7,4,15,'هُنَّ'),(8,4,13,'أُمَّهَٰتِهِمۡۖ'),(9,4,17,'إِنۡ'),(10,4,17,'أُمَّهَٰتُهُمۡ'),(11,4,17,'إِلَّا'),(12,4,17,'ٱلَّٰٓـِٔي'),(13,4,17,'وَلَدۡنَهُمۡۚ'),(14,4,17,'وَإِنَّهُمۡ'),(15,4,17,'لَيَقُولُونَ'),(16,4,17,'مُنكَرٗا'),(17,4,17,'مِّنَ'),(18,4,17,'ٱلۡقَوۡلِ'),(19,4,17,'وَزُورٗاۚ'),(20,4,17,'وَإِنَّ'),(21,4,17,'ٱللَّهَ'),(22,4,17,'لَعَفُوٌّ'),(23,4,17,'غَفُورٞ'),(24,4,17,'٢');
